...
function updateSilver() {
    document.getElementsByClassName("input input--tiny qa-currentbalance input--full  ").item(0).value = (silverAmount * silverPrice).toFixed(2);
    document.getElementsByClassName("input input--tiny qa-currentbalance input--full  ").item(0).dispatchEvent(new KeyboardEvent('keypress', {
        'key': '0',
        'shift': true,
        'bubbles': true,
        'cancelable': true
...
function fillSilver() {
    if(document.getElementsByClassName("input input--tiny qa-currentbalance input--full  ").item(0) == null) {
        ...
        document.getElementsByClassName("input input--tiny qa-currentbalance input--full  ").item(0).setAttribute('onkeydown', updateSilver());
